...
def word_map(matrix, direction):
    ...
    down_or_across = [i for i in down_or_across if i != 0]
...
puzzle = get_puzzel()
puzzle = puzzle.astype('str')[:5]


across_words = word_map(puzzle, 'across')
down_words = word_map(puzzle, 'down')
